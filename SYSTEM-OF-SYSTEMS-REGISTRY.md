...
| Process Spine | future canonical process control | `projects/xzenia/process-spine/` | DESIGN-ACTIVE | prove or hold |
| Model redundancy | secondary cognition safety | config + provider/runtime surfaces | BROKEN | repair or narrow claim |
| Task queue | queued work substrate | `task-queue/` | PROVED | clear stale residue |
| Context Nexus | memory continuity | `.openclaw/context-nexus/` + plugin | PROVED AS PRESENT | validate live leverage patterns |
